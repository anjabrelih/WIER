...
class Spider:
    ...
    def __init__(self, project_name, base_url, domain_name):
        ...
        Spider.base_url = base_url            #SHARED INFORMATION
        Spider.domain_name = domain_name
        Spider.queue_file = Spider.project_name + '/queue.txt'
        Spider.crawled_file = Spider.project_name + '/crawled.txt'
        self.boot()
        self.crawl_page('First Spider', Spider.base_url) #prvi pajek odpre začetno stran

 #Z začetka uporabimo samo enega pajka ker imamo v queue.txt samo en link
